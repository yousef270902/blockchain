<?php
require("C:/xampp/htdocs/folders/databaseconnection/db-conn.php");
$id = $_GET["id"];
...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `Campains` SET `Title`='$Title',`Description`='$Description',`EndDate`='$EndDate',`TargetFunds`='$TargetFunds' WHERE Id = $id";
...
<body>
  ...
  <div class="container">
    ...
    <?php
    $sql = "SELECT * FROM `Campains` WHERE Id = $id LIMIT 1";
    $result = mysqli_query($conn, $sql);
