    ...
    <div class="mask" style="background-color: rgba(0, 0, 0, 0.8);">
      <div class="container d-flex align-items-center justify-content-center text-center h-100">
        <div class="text-white" data-mdb-theme="dark" id="start">
          ...
          <button class="btn btn-outline-light btn-lg m-2"  onclick="sign()"data-target="#signup" id="startcampain" >visit</button>
    ...
    <div class="modal signup" id="signup">
          ...
          <div class="modal-body">
            <form class="form-group" method="post" action ="">
              ...
              <input type="text" id="username" name="username" class="form-control input" onkeydown="return /[a-zA-Z\s]/i.test(event.key)" required>
              <br>
              ...
              <br>
              <input type="submit" class="btn btn-primary" onclick="move()" name="submit" value="Create Campaign">
              <input type="submit" class="btn btn-primary" onclick="move()" name="submit" value="Donate Campaign">
              <input type="submit" class="btn btn-primary" onclick="move()" name="submit" value="invest Campaign">
            </form>    
          </div>
          <!-- Modal footer -->
