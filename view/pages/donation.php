    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0c" style="padding:4px;">
            ...
            <li class="nav-item">
              <button class="nav-link" onclick="showcamp()" style="border:none;">Campaign</button>
            </li>
            <li class="nav-item">
            ...
            <form class="form-inline mb-4" id="searchForm">
              <input class="form-control mr-sm-2" type="search" id="searchInput" placeholder="Search" name="catgory">
  ...
  <div class="container mt-4">
    <h4 class="text-center mb-4 campaigns-heading">Campaigns</h4>
        <form class="form-inline mb-4">
            ...
            <select class="form-control mr-sm-2" id="filter">
       ...
       ?>
          ...
          <div class="row" id="campaignsContainer" style="display:none;">
          <div class="row">
        ...
        <div class="col-sm-4">
            <div class="card campaign-card">
                <div class="card-body">
                    ...
                    <button href="#" class="btn btn-primary mt-3" onclick="connectmetamask()">meta_mask</button>
